...
print('Enclosed by loop:', enclosed)
print()
...
"""
or part 2, I remembered that you can tell if something is inside or outside a loop by counting how many times you cross the loop on the way out, 
in any direction. If it is an odd number of crossings, you were inside. Maybe this is how everyone is solving it.

I realized that if moving horizontally, '-' tiles don't need to count. But what gave me trouble was the corner tiles. 
Are you crossing the loop when you pass over one, or not?

What I finally did is count the 'L' and '7" tiles as a positive .5, and the 'J' and 'F' as negative .5
"""